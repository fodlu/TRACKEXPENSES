...
const IncomePage = () => {
		...
		async (range = timeFrame ?? "monthly") => {
			try {
				...
				if (res.data?.success) {
					...
					setOverview({
						totalIncome: payload.totalIncome ?? null,
						averageIncome: payload.averageIncome ?? null,
						numberOfTransactions: payload.numberOfTransactions ?? null,
	...
	const averageIncome = useMemo(
		() =>
			overview.averageIncome ? Math.round(overview.averageIncome)
